...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $mang = explode(',', $_POST['mang']);  // Tách mảng từ chuỗi nhập vào
...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="text" id="mang" name="mang" value="<?php echo isset($_POST['mang']) ? $_POST['mang'] : ''; ?>" required><br><br>

            <label for="checkValue">Nhập giá trị cần kiểm tra:</label><br>
            <input type="text" id="checkValue" name="checkValue" value="<?php echo isset($_POST['checkValue']) ? $_POST['checkValue'] : ''; ?>" required><br><br>
